 ...
 * ###################################################
 */
// Sparkfun library for Barometric Pressure Sensor BMP180
#include <SFE_BMP180.h>

// Library for GY-85 IMU Sensor (Accelerometer, Gyro, Compass)
#include <GY_85.h>

// I²C/TWI library for (sensor) communications
#include <Wire.h>
 ...
 * ###################################################
 * 
 * GY-85 Breakout --------- Arduino
 * VCC_IN -------------------- 5V
 * SDA ----------------------- SDA
 * SCL ----------------------- SCL
 * GND ---------------------- GND

 * Note: The GY-85 is an I2C sensor and uses the Arduino Wire library.
 * We are using the 400 kHz fast I2C mode by setting the TWI_FREQ  to 400000L /twi.h utility file.
*/
...
/* ###################################################
 * ######## IMU Filtering Algorithms #################
 * ###################################################
 */

// Thank you Kris Winer (https://github.com/kriswiner) for providing this implementation
